...
const ItemsList = [
  {
    ...
    availableColors: [
      { color: Color.BLACK, src: "./images/product-17.webp" },
  ...
  },
  {
    ...
    availableColors: [{ color: Color.BEIGE, src: "./images/product-18.webp" }],
    onSale: true,
  },
  {
    id: 3,
    ...
    availableColors: [
      { color: Color.PEARL_PINK, src: "./images/product-19.webp" },
  ...
  },
  {
    ...
    availableColors: [
      { color: Color.GREY, src: "./images/product-20.webp" },
